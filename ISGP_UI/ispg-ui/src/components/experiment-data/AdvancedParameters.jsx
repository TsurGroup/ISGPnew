...
const AdvancedParameters = () => {     
    ...
    return (
         <Box component="fieldset" style = {commonStyles}>
             ...
             <NumberField name="normFactor" defaultValue ={0.05} minValue={1} maxValue={5} increment={0.05}  label="Normalization penalty" toolTip="Penalty for not being properly normalized"/>
             <NumberField name="pointDiff" defaultValue ={3} minValue={1} maxValue={20} increment={1} label="Point Diff Factor"/>
             <NumberField name="widthFactor" defaultValue ={8} minValue={0} maxValue={45} increment={1} label="Width Factor"/>
